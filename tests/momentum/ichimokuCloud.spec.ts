...
describe('ichimoku cloud', () => {
  ...
  it('should able to calculate ichimoku cloud with default options', () => {
    ...
    const expectedConversion = [
      170.51, 170.47, 171.63, 172.5, 172.55, 172.55, 172.55, 171.35,
      ...
      176.17, 176.53, 176.53, 176.53, 177.42, 177.95, 177.95, 178.9,
      178.9, 178.6, 178.6, 177.4, 176.05, 174.2, 172.73, 172.59,
      172.03, 171.21, 170.64, 169.81, 169.81, 169.81, 169.81, 169.81,
      169.35, 169.35, 169.5, 170.31, 170.48, 173.57, 173.57, 174.4,
    ...
    const expectedBase = [
      170.51, 170.47, 171.63, 172.5, 172.55, 172.55, 172.55, 171.35,
      171.35, 171.35, 171.35, 171.35, 171, 171, 171, 171,
      171, 171, 171, 171, 171.83, 171.83, 171.83, 171.83,
    ...
    const expectedLeadingA = [
      170.51, 170.47, 171.63, 172.5, 172.55, 172.55, 172.55, 171.35,
      171.35, 171.35, 171.35, 171.35, 171, 170.89, 170.83, 170.35,
      170.34, 170.5, 170.5, 170.66, 171.83, 172.41, 172.41, 172.41,
      ...
      170.8, 170.98, 170.98, 170.98, 171.87, 172.4, 172.4, 172.88,
      172.88, 172.73, 174.55, 174.98, 174.63, 174.2, 173.47, 173.4,
      173.11, 172.7, 172.32, 171.9, 171.9, 171.9, 171.9, 171.9,
      171.67, 171.67, 171.75, 172.15, 172.24, 173.78, 173.78, 173.45,
