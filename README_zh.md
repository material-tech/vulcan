...
| 包名 | 说明 |
| --- | --- |
| [`@material-tech/vulcan-core`](./packages/core/) | 核心类型（`CandleData`、`Processor`、`SignalGenerator`）及工具函数（`createSignal`、`collect`） |
| [`@material-tech/vulcan-indicators`](./packages/indicators/) | 全部技术指标（趋势、动量、成交量） |
| [`@material-tech/vulcan-strategies`](./packages/strategies/) | 可组合的交易策略，输出结构化信号 |
| [`@material-tech/vulcan-backtest`](./packages/backtest/) | 回测引擎，含仓位管理和统计分析 |
